...
namespace DynamoLeague.Business.Data.Migrations
{
    ...
    [Migration("20200607161504_DropFineTeamId")]
    partial class DropFineTeamId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DynamoLeague.Business.Data.Models.FreeAgent", b =>
                {
                    b.Property<int>("FreeAgentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("FreeAgentId");

                    b.HasIndex("PlayerId");

                    b.ToTable("FreeAgents");
                });
            ...
            modelBuilder.Entity("DynamoLeague.Business.Data.Models.Bid", b =>
                {
                    b.HasOne("DynamoLeague.Business.Data.Models.FreeAgent", "FreeAgent")
                        .WithMany()
                        .HasForeignKey("FreeAgentId")
